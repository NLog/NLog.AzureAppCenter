...
namespace NLog.Targets.Xamarin
{
    ...
    /// </summary>
    [Target("DebugXamarin")]
    public class XamarinAndroidTarget : TargetWithLayoutHeaderAndFooter
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XamarinAndroidTarget"/> class.
        /// </summary>
        public XamarinAndroidTarget()
        {
            Layout = "${message}";
            Category = "${logger}";
        }
